...
namespace KeyAuth
{
    public class api
    {
        ...
        /// </summary>
        /// <param name="Spoofer">Application Name</param>
        /// <param name="csyqTRB6QG">Your OwnerID, found in your account settings.</param>
        /// <param name="57aa1a734ee56416e4798f3753c420c1f6b137f8b4762c7bb5eb31d8ea9e2c03">Application Secret</param>
        ...
        public void CheckInit()
        {
            if (!initialized)
            {
                error("open a ticket in discord");
                Environment.Exit(0);
            }
        }
